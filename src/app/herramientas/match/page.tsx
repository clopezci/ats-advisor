    ...
    <div className="flex flex-1 flex-col gap-5">
      <section className="bento-card space-y-2">
        <div className="flex items-start justify-between gap-3">
          <div>
            <p className="text-xs uppercase tracking-[0.14em] muted">Fase 4 · SEO gratis</p>
            <h1 className="mt-1 text-2xl font-semibold">Calculadora de match CV ↔ oferta</h1>
          </div>
          <SpeakButton text="Pega tu CV y la oferta. Obtén un porcentaje rápido de solapamiento de palabras clave." />
        </div>
        <p className="text-sm muted">
          Vista previa gratuita. Para score ATS completo (formato, must-haves, heatmap) usa el
          analizador.
        </p>
      </section>
      ...
      <label className="block text-sm">
        ...
        <textarea
          ...
          placeholder="Pega un extracto de tu HV…"
        />
