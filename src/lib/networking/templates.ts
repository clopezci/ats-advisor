...
export type NetworkTemplate = {
  ...
  subject?: string;
  short: string;
  /** Límite ~200 caracteres (mensaje corto en red profesional). */
  inmail?: string;
  long?: string;
};
...
export const NETWORK_TEMPLATES: NetworkTemplate[] = [
  {
    ...
    subject: "Networking — [Tu nombre] · [target]",
    short:
    ...
    inmail:
      "Hola [Nombre], soy [Tu nombre] ([rol]). Busco [target]. ¿15 min esta semana para orientación de mercado? Gracias.",
    long:
  ...
  },
  {
    ...
    subject: "Update búsqueda — [Tu nombre]",
    short:
    ...
    inmail:
      "Hola [Nombre], update: busco [rol], foco [sector]. Si abre algo alineado, ¿me avisas? Gracias.",
  },
  {
    id: "excolega",
    label: "Excolega / par",
    tip: "Ancla compartida + favor concreto (menos de 20 min).",
    subject: "Saludo y networking — [Tu nombre]",
    short:
      "Hola [Nombre], ¿cómo vas? Estoy en transición hacia [rol]. ¿Me podrías [favor concreto]? Te cuento cómo me fue.",
    inmail:
      "Hola [Nombre], estoy en transición a [rol]. ¿Me ayudas con [favor concreto]? Gracias.",
    long:
  ...
  },
  {
    ...
    inmail:
      "Busco [rol] en [ciudad/modalidad]. Si conoces a alguien en [sector], ¿me presentas?",
  },
  {
    id: "hr_empresa",
    label: "Selección / HR (empresa objetivo)",
    tip: "Interés específico por área; pregunta por horizonte.",
    subject: "Interés en [área] — [Tu nombre]",
    short:
    ...
    inmail:
      "Hola [Nombre], interés en [Empresa]/[área]. ¿Procesos abiertos o previstos? Gracias.",
    long:
  ...
  },
  {
    ...
    subject: "Conversación de mercado — [área]",
    short:
    ...
    inmail:
      "Hola [Nombre], vi [ancla]. Trabajo en [expertise] ([logro]). ¿15 min sobre prioridades del equipo?",
    long:
  ...
  },
  {
    ...
    subject: "Conversación de mercado — [Empresa]",
    short:
    ...
    inmail:
      "Hola [Nombre], trabajo en [dominio]. ¿10–15 min sobre el área [X] en [Empresa]? (conversación de mercado).",
  },
  {
    id: "followup",
    label: "Follow-up (día 5–7)",
    tip: "Una sola vez; dos horarios; sin culpa.",
    subject: "Re: networking — [tema]",
    short:
      "Hola [Nombre], retomo por si se te pasó mi nota sobre [tema]. Sigo disponible [día A] o [día B]. Gracias.",
    inmail:
      "Hola [Nombre], retomo mi nota sobre [tema]. ¿[día A] o [día B]? Gracias.",
  },
];
